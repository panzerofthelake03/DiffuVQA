...
- Execution tracker: [shared/TODO.md](shared/TODO.md)
- Decision and phase history: [shared/CHANGELOG.md](shared/CHANGELOG.md)

Phase completion rule:
- When a phase is completed, update both [shared/TODO.md](shared/TODO.md) and [shared/CHANGELOG.md](shared/CHANGELOG.md) on the same day.
- Include completed tasks, accepted trade-offs, key metrics, and artifact locations.